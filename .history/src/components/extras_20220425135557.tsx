...
export const Message = () => {
  const data:cartItemProps = useSelector(cartItemTextState)
  console.log('cartItemText' ,  data.cartItem .content, data.cartItem.styles, data)
  return (
    <div className="message none">
      <div className={data.cartItem.styles}>{data.cartItem.content}</div>
    </div>
  );
};
