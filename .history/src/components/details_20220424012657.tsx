...
import { Back, bgRotation, CartImg, Message } from "./extras";
...
function Details() {
  ...
  console.log(data.expandedItem.item.rating.rate, data.expandedItem.item.rating.rate * 20)
          ...
          <div className="content">
            ...
            <div className="price-rating">
              ...
              <div className="rating">
                <div className="rate">
              <Rating ratingValue= {data.expandedItem.item.rating.rate * 20} allowHalfIcon readonly />
