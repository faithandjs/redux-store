...
function Home() {
  ...
  return (
    <div>
      <h1>home</h1>
      <div>
        <div className="image"><img src="searchImg"/></div>
      <input
        type="text"
      ...
      <div className="categories">
        <div className="image"><img src="searchImg"/></div>
        <div onClick={() => categorySelected()}>all</div>
        <div onClick={() => categorySelected()}>women's clothing</div>
        <div onClick={() => categorySelected()}>men's clothing</div>
        <div onClick={() => categorySelected()}>jewelery</div>
        <div onClick={() => categorySelected()}>electronics</div>
      </div>
      <CartImg path="/" />
      {pageContent}
    </div>
