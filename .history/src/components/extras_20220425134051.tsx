...
}; //{cartState.items.items[n].count ? cartState.items.items[n].count  : null}     <div className={data.styles}>{data.content}</div>
export const Back = () => {
  const navigate = useNavigate();
  return (
    <div
...
//const data:textProp = useSelector(cartItemTextState)
